#ifndef __TENSORRECONSTRUCTIONFILTER_ITK_H
#define __TENSORRECONSTRUCTIONFILTER_ITK_H
...
//    itkGetConstReferenceMacro(BValue, VectorType);
    ...
    double m_beforetime;
protected:
    TensorReconstructionFilter_itk();
    ~TensorReconstructionFilter_itk() {}
...
#endif // __TENSORRECONSTRUCTIONFILTER_ITK_H
