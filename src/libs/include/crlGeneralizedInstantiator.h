...
public:
	 ...
	 * \return	.
	 *************************************************************************************************/
	AlgoBaseType::Pointer Instantiate(itk::ImageIOBase::IOPixelType pixelType,
			itk::ImageIOBase::IOComponentType componentType,
			unsigned int dimensionality) {
	...
	AlgoBaseType::Pointer InstantiateForceComponentType(const ImageTypeInfos &infos, const std::string& componentType ) 
	{
#ifdef CRL_GA_SCALAR_CLASS
		if (infos.pixelType == itk::ImageIOBase::SCALAR)
		{
			if ( componentType=="uchar" ) return InstantiateScalar<unsigned char, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="char" ) return InstantiateScalar<char, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="ushort" ) return InstantiateScalar<unsigned short, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="short" ) return InstantiateScalar<short, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="uint" ) return InstantiateScalar<unsigned int, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="int" ) return InstantiateScalar<int, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="ulong" ) return InstantiateScalar<unsigned long, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="long" ) return InstantiateScalar<long, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="float" ) return InstantiateScalar<float, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="double" ) return InstantiateScalar<double, MAX_IMAGE_DIM>::Instantiate (infos);
			else return NULL;
		}
#endif
#ifdef CRL_GA_VECTORIMAGE_CLASS
		if (infos.pixelType == itk::ImageIOBase::VECTOR)
		{
			if ( componentType=="uchar" ) return InstantiateVectorImage<unsigned char, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="char" ) return InstantiateVectorImage<char, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="ushort" ) return InstantiateVectorImage<unsigned short, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="short" ) return InstantiateVectorImage<short, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="uint" ) return InstantiateVectorImage<unsigned int, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="int" ) return InstantiateVectorImage<int, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="ulong" ) return InstantiateVectorImage<unsigned long, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="long" ) return InstantiateVectorImage<long, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="float" ) return InstantiateVectorImage<float, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="double" ) return InstantiateVectorImage<double, MAX_IMAGE_DIM>::Instantiate (infos);
			else return NULL;
		}
#endif
#ifdef CRL_GA_VECTOR_CLASS
		if (infos.pixelType == itk::ImageIOBase::VECTOR)
		{
			if ( componentType=="uchar" ) return InstantiateVector<unsigned char, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="char" ) return InstantiateVector<char, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="ushort" ) return InstantiateVector<unsigned short, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="short" ) return InstantiateVector<short, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="uint" ) return InstantiateVector<unsigned int, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="int" ) return InstantiateVector<int, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="ulong" ) return InstantiateVector<unsigned long, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="long" ) return InstantiateVector<long, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="float" ) return InstantiateVector<float, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="double" ) return InstantiateVector<double, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
			else return NULL;
		}
#endif
#ifdef CRL_GA_DIFFTENSOR_CLASS
		if ( (infos.imageIO->GetPixelType() == itk::ImageIOBase::SYMMETRICSECONDRANKTENSOR)
				|| (infos.imageIO->GetPixelType() == itk::ImageIOBase::DIFFUSIONTENSOR3D) )
		{
			if ( componentType=="float" ) return InstantiateTensor<float, MAX_IMAGE_DIM>::Instantiate (infos);
			else if ( componentType=="double" ) return InstantiateTensor<double, MAX_IMAGE_DIM>::Instantiate (infos);
			else return NULL;
		}
#endif
		return NULL;
	 ...
	 * \return	.
	 *************************************************************************************************/
	template<class Type> AlgoBaseType::Pointer InstantiateFixedType(
			const ImageTypeInfos &infos) {

#ifdef CRL_GA_SCALAR_CLASS
		if (infos.pixelType == itk::ImageIOBase::SCALAR)
		{
			return InstantiateScalar<Type, MAX_IMAGE_DIM>::Instantiate (infos);
		}
#endif
		...
		if (infos.pixelType == itk::ImageIOBase::VECTOR)
		{
			return InstantiateVectorImage<Type, MAX_IMAGE_DIM>::Instantiate (infos);
		}
#endif
		...
		if (infos.pixelType == itk::ImageIOBase::VECTOR)
		{
			return InstantiateVector<Type, MAX_VEC_COMPONENT_DIM, MAX_IMAGE_DIM>::Instantiate (infos);
		}
#endif
		...
		if ( (infos.imageIO->GetPixelType() == itk::ImageIOBase::SYMMETRICSECONDRANKTENSOR)
				|| (infos.imageIO->GetPixelType() == itk::ImageIOBase::DIFFUSIONTENSOR3D) )
		{
			return InstantiateTensor<Type, MAX_IMAGE_DIM>::Instantiate (infos);
		}
#endif
		return NULL;
	}
