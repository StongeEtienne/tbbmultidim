...
typedef vnl_matrix_fixed<double,3,3>	VnlMatrix3x3;
typedef vnl_vector_fixed<double,3>		VnlVector3;
...
typedef itk::SymmetricEigenAnalysis< vnl_matrix_fixed<double,3,3> , vnl_vector_fixed<double,3>, vnl_matrix_fixed<double,3,3> > SymmetricEigenAnalysisType3x3;
...
void Tensor2VnlMatrix(VnlMatrix3x3 &out, const TensorPixelType &tensor ) ;
void Tensor2VnlMatrix(VnlMatrix3x3 &out, const FloatTensorPixelType &tensor ) ;


void VnlMatrix2Tensor( TensorPixelType &out , const vnl_matrix<double> &m ) ;
void VnlMatrix2Tensor( TensorPixelType &out , VnlMatrix3x3 &m ) ;
void VnlMatrix2Tensor( FloatTensorPixelType &out , const vnl_matrix<double> &m ) ;
void VnlMatrix2Tensor( FloatTensorPixelType &out , const VnlMatrix3x3 &m ) ;
