...
namespace crl{
	...
	*************************************************************************************************/
	...
	public:
		...
		void									Allocate( const DWIStudy<TPixel>& geometry );
		void									Allocate( const DWIStudy<TPixel>& geometry, int numberOfGradients );
		void									Allocate( const typename DWIGradientImageSetType::Pointer& geometry );
		void									Allocate( const typename DWIGradientImageSetType::Pointer& geometry, int numberOfGradients );
		...
		void									Set(const typename DWIGradientImageSetType::Pointer& data, double nominalB, const GradientVectorSetType& normalizedGradients, const BValueSetType& bvalues );
	...
	protected:
		...
		void									string2vector(const std::string& str, std::vector<double> &outputVals );
