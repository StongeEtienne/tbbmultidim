#ifndef __ITKPSDTENSORESTIMATIONFILTER_TBB_TXX
#define __ITKPSDTENSORESTIMATIONFILTER_TBB_TXX

#include "itkPSDTensorEstimationFilter_tbb.h"
...
/************************************************************************************************
 * \class	PSDTensorEstimationFilter_tbb
 *
 * \brief	PSDTensorEstimationFilter_tbb
 *
...
PSDTensorEstimationFilter_tbb< TInputImagePixelType,
TOutputImageType,
TTensorPixelType,
TMaskImageType >
::PSDTensorEstimationFilter_tbb()
{
...
template< class TInputImagePixelType,
          class TOutputImageType, class TTensorPixelType,
          class TMaskImageType >
void PSDTensorEstimationFilter_tbb< TInputImagePixelType,
TOutputImageType,
TTensorPixelType,
TMaskImageType >
...
//		typedef itk::ParticleSwarmOptimizer OptimizerType;		
    ...
    typedef itk::MyCostFunction<TInputImagePixelType, OutputImageType3> CostFunType;
...
#endif // __ITKPSDTENSORESTIMATIONFILTER_TBB_TXX
