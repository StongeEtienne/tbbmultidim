#ifndef __TENSORRECONSTRUCTIONFILTER_TBB_H
#define __TENSORRECONSTRUCTIONFILTER_TBB_H
...
class ITK_EXPORT TensorReconstructionFilter_tbb:
        public TBBImageToImageFilter< Image< TReferenceImagePixelType, 3 >,
        Image< DiffusionTensor3D< TTensorPixelType >, 3 > > 
{
public:
    typedef TensorReconstructionFilter_tbb Self;
    typedef SmartPointer< Self > Pointer;
    typedef SmartPointer< const Self > ConstPointer;
    typedef TBBImageToImageFilter< Image< TReferenceImagePixelType, 3 >,
    Image< DiffusionTensor3D< TTensorPixelType >, 3 >  >
    Superclass;
    ...
    itkTypeMacro(TensorReconstructionFilter_tbb,
                 Superclass);
...
//    itkGetConstReferenceMacro(BValue, VectorType);
    ...
    double m_beforetime;
protected:
    TensorReconstructionFilter_tbb();
    ~TensorReconstructionFilter_tbb() {}
...
#endif // __TENSORRECONSTRUCTIONFILTER_TBB_H
