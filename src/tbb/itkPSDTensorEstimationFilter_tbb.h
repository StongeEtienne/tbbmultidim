#ifndef __ITKPSDTENSORESTIMATIONFILTER_TBB_H
#define __ITKPSDTENSORESTIMATIONFILTER_TBB_H
...
class ITK_EXPORT PSDTensorEstimationFilter_tbb:
        public TBBImageToImageFilter< Image< TInputImagePixelType, 3 >,
        Image< DiffusionTensor3D< TTensorPixelType >, 3 > >
{
public:
    typedef PSDTensorEstimationFilter_tbb Self;
    typedef SmartPointer< Self > Pointer;
    typedef SmartPointer< const Self > ConstPointer;
    typedef TBBImageToImageFilter< Image< TInputImagePixelType, 3 >,
    Image< DiffusionTensor3D< TTensorPixelType >, 3 > >
    Superclass;
    /** Method for creation through the object factory. */
    itkNewMacro(Self);
    /** Runtime information support. */
    itkTypeMacro(PSDTensorEstimationFilter_tbb,
                 Superclass);
...
public:
  ...
  typedef SmartPointer< const Self >		ConstPointer;
  typedef vnl_matrix< double > CoefficientMatrixType;
  typedef itk::PSDTensorEstimationFilter_tbb<
...
#endif // __ITKPSDTENSORESTIMATIONFILTER_TBB_H
