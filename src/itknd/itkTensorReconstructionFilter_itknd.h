#ifndef __TENSORRECONSTRUCTIONFILTER_ITKND_H
#define __TENSORRECONSTRUCTIONFILTER_ITKND_H
...
class ITK_EXPORT TensorReconstructionFilter_itknd:
        public CRLImageToImageFilter< Image< TReferenceImagePixelType, 3 >,
        Image< DiffusionTensor3D< TTensorPixelType >, 3 > > 
{
public:
    typedef TensorReconstructionFilter_itknd Self;
    typedef SmartPointer< Self > Pointer;
    typedef SmartPointer< const Self > ConstPointer;
    typedef CRLImageToImageFilter< Image< TReferenceImagePixelType, 3 >,
    Image< DiffusionTensor3D< TTensorPixelType >, 3 >  >
    Superclass;
    ...
    itkTypeMacro(TensorReconstructionFilter,
                 Superclass);
...
* gradient directions) */
    ...
    typedef Eigen::Matrix<double, 7, 7> TensorBasisMatrixType;
...
//    itkGetConstReferenceMacro(BValue, VectorType);
    ...
    double m_beforetime;
protected:
    TensorReconstructionFilter_itknd();
    ~TensorReconstructionFilter_itknd() {}
...
#endif // __TENSORRECONSTRUCTIONFILTER_ITKND_H
