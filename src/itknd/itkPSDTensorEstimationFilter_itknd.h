#ifndef __ITKPSDTENSORESTIMATIONFILTER_ITKND_H
#define __ITKPSDTENSORESTIMATIONFILTER_ITKND_H
...
class ITK_EXPORT PSDTensorEstimationFilter_itknd:
        public CRLImageToImageFilter< Image< TInputImagePixelType, 3 >,
        Image< DiffusionTensor3D< TTensorPixelType >, 3 > >
{
public:
    typedef PSDTensorEstimationFilter_itknd Self;
    typedef SmartPointer< Self > Pointer;
    typedef SmartPointer< const Self > ConstPointer;
    typedef CRLImageToImageFilter< Image< TInputImagePixelType, 3 >,
    Image< DiffusionTensor3D< TTensorPixelType >, 3 > >
    Superclass;
    /** Method for creation through the object factory. */
    itkNewMacro(Self);
    /** Runtime information support. */
    itkTypeMacro(PSDTensorEstimationFilter_itknd,
                 Superclass);
...
class ITK_EXPORT MyCostFunction2
    : public itk::SingleValuedCostFunction
{
public:
  /** Standard class typedefs */
  typedef MyCostFunction2					Self;
  typedef SingleValuedCostFunction			Superclass;
  typedef SmartPointer< Self >				Pointer;
  typedef SmartPointer< const Self >		ConstPointer;
  typedef vnl_matrix< double > CoefficientMatrixType;
  typedef itk::PSDTensorEstimationFilter_itknd<
            TInputPixelType, TOutputType >  PSDTensorEstimationFilterType;

  /** Run-time type information (and related methods). */
  itkTypeMacro(MyCostFunction2, SingleValuedCostFunction) ;
...
#endif // __ITKPSDTENSORESTIMATIONFILTER_ITKND_H
