#ifndef __ITKPSDTENSORESTIMATIONFILTER_TBBND_TXX
#define __ITKPSDTENSORESTIMATIONFILTER_TBBND_TXX

#include "itkPSDTensorEstimationFilter_tbbnd.h"
...
PSDTensorEstimationFilter_tbbnd< TInputImagePixelType,
TOutputImageType,
TTensorPixelType,
TMaskImageType >
...
template< class TInputImagePixelType,
          class TOutputImageType, class TTensorPixelType,
          class TMaskImageType >
void PSDTensorEstimationFilter_tbbnd< TInputImagePixelType,
TOutputImageType,
TTensorPixelType,
TMaskImageType >
...
//		typedef itk::ParticleSwarmOptimizer OptimizerType;		
    ...
    typedef itk::MyCostFunction_tbbnd<TInputImagePixelType, OutputImageType3> CostFunType;
...
/*		
		...
		for (int i=0; i<7; i++)
			{
			lbound.push_back(-6e-2);
			ubound.push_back(6e-2);
			}
...
//                    std::cout<<" = "<<optimizer->GetErrorCodeDescription()<<endl;
		...
		#ifdef USE_ITK_OPTIMIZER
//		    funcEvalIterator.Set(optimizer->GetCurrentIteration()); // Powell Optimizer
		#else
...
//          class TOutputImageType, class TTensorPixelType,
//          class TMaskImageType >
//DataObject::Pointer PSDTensorEstimationFilter< TInputImagePixelType,
//TOutputImageType,
//TTensorPixelType,
//TMaskImageType >
...
#endif // __ITKPSDTENSORESTIMATIONFILTER_TBBND_TXX
