#ifndef __ITKPSDTENSORESTIMATIONFILTER_TBBND_H
#define __ITKPSDTENSORESTIMATIONFILTER_TBBND_H
...
/************************************************************************************************
 * \class	PSDTensorEstimationFilter_tbbnd
 *
 * \brief	PSDTensorEstimationFilter_tbbnd
 *
...
class ITK_EXPORT PSDTensorEstimationFilter_tbbnd:
        public TBBNDImageToImageFilter< Image< TInputImagePixelType, 3 >,
        Image< DiffusionTensor3D< TTensorPixelType >, 3 > >
{
public:
    typedef PSDTensorEstimationFilter_tbbnd Self;
    typedef SmartPointer< Self > Pointer;
    typedef SmartPointer< const Self > ConstPointer;
    typedef TBBNDImageToImageFilter< Image< TInputImagePixelType, 3 >,
    Image< DiffusionTensor3D< TTensorPixelType >, 3 > >
    Superclass;
    /** Method for creation through the object factory. */
    itkNewMacro(Self);
    /** Runtime information support. */
    itkTypeMacro(PSDTensorEstimationFilter_tbbnd,
                 Superclass);
...
#undef GetBValue
   ...
   double m_beforetime;
protected:
    PSDTensorEstimationFilter_tbbnd();
    ~PSDTensorEstimationFilter_tbbnd() {}
...
class ITK_EXPORT MyCostFunction_tbbnd
    : public itk::SingleValuedCostFunction
{
public:
  /** Standard class typedefs */
  typedef MyCostFunction_tbbnd					Self;
  typedef SingleValuedCostFunction			Superclass;
  typedef SmartPointer< Self >				Pointer;
  typedef SmartPointer< const Self >		ConstPointer;
  typedef vnl_matrix< double > CoefficientMatrixType;
  typedef itk::PSDTensorEstimationFilter_tbbnd<
            TInputPixelType, TOutputType >  PSDTensorEstimationFilterType;

  /** Run-time type information (and related methods). */
  itkTypeMacro(MyCostFunction_tbbnd, SingleValuedCostFunction) ;
...
protected:
  MyCostFunction_tbbnd() {

  }
  virtual ~MyCostFunction_tbbnd() {}
...
#endif // __ITKPSDTENSORESTIMATIONFILTER_TBBND_H
